          ...
          <div className="centered-container">
            <div className="workshop-container">
              <div className="workshop-section">
                ...
                <p>
                  <em>
                    Travel grant funding for HARVEST-Vision 2027 is not yet confirmed. The
                    structure below reflects the support offered at previous editions and is
                    subject to change.
                  </em>
                </p>
                <p>
                ...
                <ol>
                  <li>
                    ...
                    <ul>
                      ...
                      <li>What you would like to learn from attending HARVEST-Vision 2027</li>
                      <li>
