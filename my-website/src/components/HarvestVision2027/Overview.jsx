...
const Overview = () => {
  return (
    <section className="about" id="overview">
      ...
      <ul className="left-align">
        <li>The <strong>HARVEST Workshop Series</strong> was launched to build community and cyberinfrastructure at the intersection of AI, HPC, and agriculture. This is its <strong>fourth edition</strong>.</li>
        ...
        <li>The <strong><Link to="/india-2026">3rd edition</Link></strong>, HARVEST-India, is a half-day workshop held in cooperation with HiPC 2026.</li>
